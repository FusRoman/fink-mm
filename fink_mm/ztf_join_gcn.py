...
def ztf_join_gcn(
    ...
    >>> list(datajoin.columns)
    ['DR3Name', 'Plx', 'anomaly_score', 'candid', 'cdsxmatch', 'day', 'delta_mag', 'diff_vartime', 'e_Plx', 'event', 'fid', 'fink_class', 'from_upper', 'gcn_dec', 'gcn_loc_error', 'gcn_ra', 'gcn_status', 'gcvs', 'instrument', 'is_grb_bronze', 'is_grb_gold', 'is_grb_silver', 'is_gw_bronze', 'jd', 'jdstarthist', 'lc_features_g', 'lc_features_r', 'magpsf', 'mangrove', 'month', 'mulens', 'nalerthist', 'objectId', 'observatory', 'p_assoc', 'rate', 'raw_event', 'rb', 'rf_kn_vs_nonkn', 'rf_snia_vs_nonia', 'roid', 'sigmapsf', 'snn_sn_vs_all', 'snn_snia_vs_nonia', 'start_vartime', 'timestamp', 'triggerId', 'triggerTimeUTC', 'vsx', 'x3hsp', 'x4lac', 'year', 'ztf_dec', 'ztf_ra']
    >>> len(datajoin)
    72
    """
    logger = init_logging()
