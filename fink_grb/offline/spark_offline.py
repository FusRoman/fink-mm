...
def ztf_grb_filter(spark_ztf):
    ...
    spark_filter = (
        ...
        .filter(
            ...
            | (spark_ztf.sgscore < 0.5) # distance of closest source from Pan-Starrs 1 catalog above 30 arcsecond
        )
        .filter(
            ...
            | (spark_ztf.sgscore < 0.5) # distance of closest source from Gaia DR1 catalog above 60 arcsecond
        )
    )
